...
The test folder names differ from training class names:
    Test-test folder  →  Training class name
    ─────────────────────────────────────────
    climb             →  unsafeClimb
    fall              →  fall
    fight             →  fight
...
This mapping is defined in TEST_CLASS_MAP below. Adjust if your
training classes differ.
